...
parser.add_argument('--save_dir', default='../model/google_squeezenet/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-squeezenet', help='Path store checkpoints')
