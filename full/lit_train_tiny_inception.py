...
parser.add_argument('--save_dir', default='../model/google_tiny_inception_SOUP_1/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-tiny-inception-SOUP-1', help='Path store checkpoints')
