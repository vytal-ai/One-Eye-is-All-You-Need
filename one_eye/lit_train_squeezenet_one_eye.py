...
parser.add_argument('--save_dir', default='../model/google_squeezenet_one_eye/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google_squeezenet_one_eye', help='Path store checkpoints')
