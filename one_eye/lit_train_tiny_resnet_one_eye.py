...
parser.add_argument('--save_dir', default='../model/google_tiny_resnet_one_eye/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-tiny-resnet-one-eye', help='Path store checkpoints')
