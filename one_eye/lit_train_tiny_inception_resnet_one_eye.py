...
parser.add_argument('--save_dir', default='../model/google_tiny_inception_resnet_one_eye/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-tiny-inception-resnet-one-eye', help='Path store checkpoints')
...
if __name__ == '__main__':
    ...
    if input("Y/y to continue, N/n to not continue: ").lower() != "y": exit()
