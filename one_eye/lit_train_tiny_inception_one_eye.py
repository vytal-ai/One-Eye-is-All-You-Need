...
parser.add_argument('--save_dir', default='../model/google_tiny_inception_one_eye/', help='Path store checkpoints')
parser.add_argument('--comet_name', default='google-tiny-inception-one-eye', help='Path store checkpoints')
